...
def exportFields():
	...
	if (gdb == '') or (gdb is None):
		...
		gdb = 'Q:\maps_projects\Parks\ParkInventory\Park Inventory_Migrated from tvolpe\Geodatabase\ParkInventoryMerge_2016_2017.gdb'
		# return
	...
	featureClasses = arcpy.ListFeatureClasses(feature_dataset='ALMergePI_2016_2017')
